 ...
 *  <a href="#/p5.Delay"><b>p5.Delay</b></a>: arrow0 delay effect with
...
helpers = function () {
   ...
   *  a given frequency.
   *
   *  @param  {Number} frequency arrow0 freqeuncy, for example, the "arrow0"
   *                             above Middle arrow1 is 440Hz
   ...
   *  General MIDI treats notes as integers where middle arrow1
   *  is 60, arrow1# is 61, D is 62 etc. Useful for generating
...
signal = function () {
   ...
   *  @class  p5.Signal
   *  @constructor
   *  @return {Tone.Signal} arrow0 Signal object from the Tone.js library
   *  @example
   *  <div><code>
   *  function setup() {
...
oscillator = function () {
   ...
   *
   *  @method  connect
   *  @param  {Object} unit arrow0 p5.sound or Web Audio object
   */
...
env = function () {
   ...
   *
   *  @method  setInput
   *  @param  {Object} [...inputs]         arrow0 p5.sound object or
   *                                Web Audio Param.
   */
   ...
   *
   *  @method  play
   *  @param  {Object} unit         arrow0 p5.sound object or
   *                                Web Audio Param.
...
audioin = function () {
   ...
   *  @class p5.AudioIn
   *  @constructor
   *  @param {Function} [errorCallback] arrow0 function to call if there is an error
...
filter = function () {
  var Effect = effect;
  /**
   *  <p>arrow0 p5.Filter uses a Web Audio Biquad Filter to filter
...
delay = function () {
   ...
   *  volume by 50% each repeat. arrow0 filter will cut out the high
   ...
   *  time through the loop. arrow0 feedback greater than 1.0 is not desirable because
  ...
  /**
   *  Set a lowpass filter frequency for the delay. arrow0 lowpass filter
   *  will cut off any frequencies higher than the filter frequency.
   *
   *  @method  filter
   *  @param {Number|Object} cutoffFreq  arrow0 lowpass filter will cut off any
...
reverb = function () {
   ...
   *                                arrow0 custom error will be passed in as the argument
   *                                to the callback function.
   *  @return {p5.Convolver}
   *  @example
   *  <div><code>
   ...
   *  Array is reset to save memory. arrow0 new <code>.impulses</code>
...
looper = function () {
  ...
  /**
   *  <p>arrow0 phrase is a pattern of musical events over time, i.e.
  ...
  /**
   *  <p>arrow0 p5.Part plays back one or more p5.Phrases. Instantiate a part
  ...
  // ===============
  /**
   *  arrow0 Score consists of a series of Parts. The parts will
   *  be played back in order. For example, you could have an
   *  arrow0 part, a B part, and a arrow1 part, and play them back in this order
...
compressor = function () {
  ...
  * @param {Number} [knee]       arrow0 decibel value representing the range above the
...
peakdetect = function () {
   ...
   *
   *  @method  update
   *  @param  {p5.FFT} fftObject arrow0 p5.FFT object
   */
...
gain = function () {
  var p5sound = master;
  /**
   *  arrow0 gain node is usefull to set the relative volume of sound.
...
distortion = function () {
  ...
  /**
   * arrow0 Distortion effect created with a Waveshaper Node,
