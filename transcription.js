...
function draw() {
    ...
    if (stage===0) {
        ...
        text("DNA transcribed", swidth*0.25, sheight*0.15);
        text("Mutations", swidth*0.38, sheight*0.15);
